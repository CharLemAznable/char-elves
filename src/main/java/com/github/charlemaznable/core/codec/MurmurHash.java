...
public final class MurmurHash {
    ...
    public static int hash(Object o) {
        ...
        if (o instanceof Integer) return hashLong((Integer) o);
        if (o instanceof Double) return hashLong(Double.doubleToRawLongBits((Double) o));
        if (o instanceof Float) return hashLong(Float.floatToRawIntBits((Float) o));
        if (o instanceof String) return hash(((String) o).getBytes());
